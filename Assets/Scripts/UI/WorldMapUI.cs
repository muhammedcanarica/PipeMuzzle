...
namespace PipeMuzzle.UI
{
    ...
    public sealed class WorldMapUI : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            worlds.AddRange(Resources.LoadAll<WorldDefinition>("Worlds"));
        ...
        private void CreateDestination(RectTransform root, WorldDefinition world, float y, bool unlocked)
        {
            ...
            image.color = unlocked ? Accent(world.WorldId) : new Color32(151, 141, 150, 255);
            ...
            CreateText(unlocked ? "12 LEVELS" : "LOCKED", rect, new Vector2(0, -28), 18, new Color(1f, 1f, 1f, .88f));
        }
        ...
        private static void CreateText(string value, RectTransform parent, Vector2 position, float size, Color color)
        {
